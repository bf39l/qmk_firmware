    ...
    */
    ...
    [0] = LAYOUT_def(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,   KC_V,    KC_B,                                  KC_N,    KC_M,   KC_COMM, KC_DOT,   KC_SLSH, KC_RSFT, MO(2),   KC_NO,
                 KC_LCTL,   KC_LALT,  KC_LGUI,    KC_SPC,        KC_NO, KC_NO, KC_NO,      KC_NO,   KC_NO,  LT(1,KC_SPC),      KC_RGUI,  KC_RALT, KC_RCTL, TG(3)
    ),
    [1] = LAYOUT_mod1(
        KC_TRNS, KC_BRID, KC_BRIU, LCTL(KC_UP), LGUI(KC_SPC), KC_TRNS,                              KC_TRNS, KC_MRWD,       KC_MPLY, KC_MFFD,        KC_MUTE, KC_VOLD, KC_VOLU, KC_BSPC,
        ...
        KC_HYPR, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,      KC_TRNS,                              KC_NO,   KC_LEFT,       KC_DOWN, KC_RIGHT,       KC_NO,   KC_TRNS, KC_TRNS, KC_NO,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,     KC_TRNS,      KC_TRNS,                              KC_NO,   LGUI(KC_LEFT), KC_NO,   LGUI(KC_RIGHT), KC_NO,   KC_TRNS, KC_TRNS, KC_NO,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                                KC_NO, KC_NO, KC_NO,     KC_NO,   KC_NO,         KC_TRNS, KC_TRNS,        KC_TRNS, KC_TRNS, KC_TRNS
    ),
    [2] = LAYOUT_mod2(
