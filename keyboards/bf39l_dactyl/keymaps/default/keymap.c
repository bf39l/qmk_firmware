...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    ...
    [0] = LAYOUT_def(
        ...
        HYPR_T(KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  KC_RBRC,
        KC_LSFT,        KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                 KC_BSPC,
        KC_LCTL,        KC_LCTL, KC_LALT, KC_LALT, KC_LGUI,        KC_SPC,        MO(2),


                     KC_DEL,         KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
                     KC_BSLS,        KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_EQL,
                     KC_QUOT,        KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
        KC_1,                       KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
        KC_2, LT(1, KC_SPC),        KC_RGUI, KC_RALT, KC_RCTL, TO(1),   TO(2)
    ...
    [1] = LAYOUT_fn(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS,
                 ...
                 KC_PGUP,  KC_HOME, LALT(KC_LEFT), KC_UP,    LALT(KC_RIGHT), KC_NUM, KC_TRNS,
                 KC_PGDN,  KC_END,  KC_LEFT,       KC_DOWN,  KC_RIGHT,       KC_NO,  KC_TRNS,
        KC_NO,             KC_TRNS, LGUI(KC_LEFT), KC_NO,    LGUI(KC_RIGHT), KC_INS, KC_TRNS,
    ...
    [3] = LAYOUT_conf(
        QK_BOOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DT_PRNT, TO(0),
        NK_ON,   NK_OFF,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DT_UP,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DT_DOWN,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS, KC_TRNS,
